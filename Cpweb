...
print "\t\t 						    \n";
print "\t\t\t Entrar al cpanel de cualquier web\n";
print "\t\t\t De: Jose Ospina   \n";
print "\t\t\t Youtube: goo.gl/7pBygz \n";
print "\t\t_________________________________________________\n";
print "\t\t/////////////////////////////////////////////////\n";
print "\n\n";
sleep (1);
    print "\t PEPITO BUSCA EL CPANEL DE TU LA WEB\n";
    print "\n\n";
    print "\t HOST=> (ex: http://www.ejemplo.com)\n";
    print "\t HOST=> :";
    $host=<STDIN>;
    chomp($host);
